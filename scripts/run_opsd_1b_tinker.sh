...
#
# Env overrides:
#   MODEL  (default: /data0/shared/Qwen3-1.7B)  -- HF id or local path
...
echo "[run_opsd_1b_tinker] OUT=$OUT"
echo "[run_opsd_1b_tinker] divergence_type=$DIV  run_config=$RUN_CONFIG"
