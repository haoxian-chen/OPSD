#!/usr/bin/env bash
# Evaluate checkpoint-400 through checkpoint-1000 in 200-step intervals produced
# by scripts/run_opsd_1b_hkaift.sh.
#
# Usage:
#   bash eval/run_eval_1b_hkaift_400_to_1000.sh <divergence_type>
#
...
#   STEP_LIST=400,600,800,1000  DATASET=aime24  VAL_N=12
...
OUT="${OUT%/}"
STEP_LIST="${STEP_LIST:-400,600,800,1000}"
...
echo "[run_eval_1b_hkaift_400_to_1000] BASE_MODEL=$BASE_MODEL"
echo "[run_eval_1b_hkaift_400_to_1000] EXP_DIR=$EXP_DIR"
echo "[run_eval_1b_hkaift_400_to_1000] mode=$MODE_NAME dataset=$DATASET val_n=$VAL_N steps=${STEP_LIST}"

for checkpoint_dir in "${CHECKPOINTS[@]}"; do
    echo "[run_eval_1b_hkaift_400_to_1000] evaluating $checkpoint_dir"
